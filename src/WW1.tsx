...
export const steps: MapSteps = [
  ...
  mapStep([
    ...
    textFadeIn(baseText('Serbia', 21.06, 43.3, { svgTextProps: { fontSize: '120%' } })),
    textFadeIn(baseText('Montenegro', 19.25, 42.85, { text: ['Monte-', 'negro'], svgTextProps: { fontSize: '70%' } })),
    textFadeIn(baseText('Bulgaria', 25.1, 42.6, { svgTextProps: { fontSize: '140%' } })),
    textFadeIn(baseText('Romania', 25.8, 44.7, { svgTextProps: { fontSize: '140%', style: { fill: 'black' } } })),
    textFadeIn(baseText('Albania', 20.15, 40.7, { svgTextProps: { fontSize: '80%' } })),
    textFadeIn(baseText('Greece', 21.6, 39.7, { svgTextProps: { fontSize: '120%' } })),
    textFadeIn(baseText('Italy', 10.1, 45, { svgTextProps: { fontSize: '140%' } })),
    textFadeIn(baseText('Bosnia', 17.6, 44.2, { svgTextProps: { fontSize: '120%' } })),
    textFadeIn(baseText('Switzerland', 8.2, 46.8, { svgTextProps: { style: { fill: 'black' } } })),
    ...
    textFontSize('Ottoman Empire', '200%'),
    textFontSize('Russian Empire', '200%'),
    textFontSize('German Empire', '160%'),
    textFontSize('Austria-Hungary', '200%'),
    highlightFadeIn(areaHighlight('Bosnia', bosniaCoordinates, { strokeDasharray: `${4 / 40} ${2.5 / 40}`, opacity: 0.55 })),
    textFadeIn(summaryText('BalkanWars', 12, 40, [
